...
export function FAQSection() {
  ...
  const items = [
    {
      q: t('Is my data safe?'),
      a: t('Yes. We use industry-standard encryption, protect sign-in on your phone, and keep a clear record of sessions and sensitive actions—so your money rules aren\'t easy to bypass or hide.'),
    },
    {
      q: t('How is KwikBudget different from other budgeting apps?'),
      a: t('Most apps only track what you spent. KwikBudget actively limits what you can spend by locking your funds and releasing a fixed daily allowance. Discipline is enforced by the product—not by willpower alone.'),
    },
    {
      q: t('How does the daily allowance work?'),
      a: t('You set a total amount and a time period (for example, GHS 600 over 30 days). The app locks the full amount, calculates your daily slice, and only that portion is available to spend each day—helping you pace through the whole period.'),
    },
    {
      q: t('What happens if I use Emergency Unlock?'),
      a: t('You can access extra money when you truly need it, but KwikBudget balances flexibility with accountability: expect a smaller future daily allowance, a cooldown before the next unlock, or similar guardrails—so emergencies don\'t erase your plan.'),
    },
    {
      q: t('What does pricing look like?'),
      a: t('We plan a solid free experience for individuals, with premium options for advanced analytics, multiple budgets, and gamified rewards. Some flows may include small fees (for example on certain withdrawals)—always shown upfront.'),
    },
  ]
